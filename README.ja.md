...
> **現在のバージョン：** [1.0.3](https://github.com/gesori-pro/PSO2_Shape_Studio/releases/tag/v1.0.3)。
...
- AQNスケルトンを含むモデルを読み込むと、名前順の一覧から編集するボーンを左右ペア
  または単独ボーンのグループとして追加できます。
- 区切り線をドラッグしてサイドバー、および標準／カスタムボーン領域の幅や高さを
  調整できます。サイドバーの幅は次回起動時に復元されます。
...
5. S/P/Rスライダーを編集します。オプション画面では標準グループを非表示にしたり、
   読み込んだモデルのボーンを追加したりできます。必要に応じて編集を元に戻す、または
   リセットします。
