...
> **현재 버전:** [1.0.3](https://github.com/gesori-pro/PSO2_Shape_Studio/releases/tag/v1.0.3).
...
- `body_root` Y 스케일로 발바닥 높이를 0.500부터 1.200까지 0.001 단위로 조절하고,
  켜고 끌 수 있는 월드 바닥 가이드와 비교할 수 있습니다.
...
- AQN 스켈레톤이 포함된 모델을 불러오면 이름순 목록에서 편집할 본을 L/R 쌍 또는 단일 본
  그룹으로 추가할 수 있습니다.
- 경계선을 드래그해 사이드바와 기본·사용자 지정 본 영역의 크기를 조절할 수 있습니다.
  사이드바 너비는 다음 실행 때 복원됩니다.
...
5. S/P/R 슬라이더를 편집합니다. 옵션 창에서는 기본 그룹을 숨기거나 불러온 모델의 본을
   추가할 수 있습니다. 필요할 때 편집을 실행 취소하거나 초기화합니다.
