...
PSO2 Shape Studio는 Blender를 사용하지 않고 PSO2 및 PSO2:NGS 캐릭터 모델을
미리 보고, 캐릭터 체형을 적용하며, 의상 체형 보정을 편집할 수 있는 Windows용 데스크톱
애플리케이션입니다.

> **개발 상태:** 프리릴리스 버전입니다. 모델 불러오기, 캐릭터 체형 적용, 텍스처 검색,
> 체형 보정의 핵심 기능은 구현되어 있지만 렌더링과 지원 형식은 계속 개선 중입니다.
